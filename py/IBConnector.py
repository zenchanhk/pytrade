...
class IBConnector:
    ...
    def __init__(self, config):
        self.connectEvent = self.Event()
        self.contractEvent = self.Event()
    ...
    def onError(self, reqId, errorCode, errorString, contract):
        ...
        #c
        if (contract != None):
            #self.last_contract_err = {'contract': contract, 'error': errorString}
            self.contractEvent.notifyAll({'contract': contract, 'error': errorString})
